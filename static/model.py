# %%
import cupy as np # use numpy here if you don't have an nvidia GPU
import pandas as pd
import time
INPUT_NODES = 784  # Your Input Neurons
OUTPUT_NODES = 10 # Output Neurons
path = "emnist-digits-train.csv" # edit The Path To Your CSV
data = pd.read_csv(path)
gfh =  784  # Layer 1 Neurons
dfh  = 784  # Layer 2 Neurons
epochs = 5 # Epochs Set LOW due to mini-batching
learning_rate = 0.01 # set your learning rate
batch_size =  32 # your batch size set higher as per gpu
save_path = "mnist_model.npz" # model save path
